...
#define B2BTRACEFILE "convbin.B2bssr"
                   ...
                   char *dir)
{
    ...
    int glofcn[MAXPRNGLO] = {
         1, -4, 5,  6, 1, -4, 5, 6, -2, -5, 0, -1,
        -2, -7, 0, -1, 4, -3, 3, 2,  4, -3, 3,  2, -8, -8, -8
    };
    for (i=0;i<MAXPRNGLO;i++) {
        opt->glofcn[i] = glofcn[i] + 8; /* FCN+8 */
    }
...
/* main ----------------------------------------------------------------------*/
int app_convbin(int argc, char **argv)
{
    rnxopt_t opt={{0}};
